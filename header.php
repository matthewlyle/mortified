	...
	<header class="m-top-large container c-red t-white p-large t-shadow ">
		...
		<nav>
			<ul class="siteNav m-bottom-large">
				<li><a href="/attend" class="siteNav__item <?php if (is_page('Attend')) {echo " is-active"; }?>">Attend <i class="fa fa-ticket" aria-hidden="true"></i></a></li>
				...
				<li><a href="/watch/mortified-nation" class="siteNav__item<?php if (is_page('Watch')) {echo " is-active"; }?>">Watch <i class="fa fa-television" aria-hidden="true"></i></a></li>
...
<div>
	<!-- <a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'hyphen' ); ?></a> -->
