	...
	if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			...
			<div class="nav-links">
				...
				<div class="nav-previous"><?php previous_comments_link( esc_html__( 'Older Comments', 'hyphen' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'hyphen' ) ); ?></div>
